...
/**
 * The Reflect Attack relic item.
 * Received from a chest; passively reflects enemy projectiles back at attackers.
 * Non-consumable — passive effect, not consumed on use.
 */
public class ReflectRelicItem extends Item {

    public static final String ITEM_ID   = "relic_reflect";
