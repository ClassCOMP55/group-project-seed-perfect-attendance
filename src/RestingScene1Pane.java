...
public class RestingScene1Pane extends GraphicsPane{
	private GLabel nextButton;
	
	public RestingScene1Pane(MainApplication mainScreen) {
	...
	private void addPlaceholderText() {
		GLabel text = new GLabel("Resting Scene 1", 100, 70);
	...
	public void mouseClicked(MouseEvent e) {
		if (mainScreen.getElementAtLocation(e.getX(), e.getY()) == nextButton) {
			mainScreen.switchToScene3Screen();
		}
	}
}
