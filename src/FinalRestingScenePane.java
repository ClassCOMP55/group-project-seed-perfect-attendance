...
public class FinalRestingScenePane extends GraphicsPane{
	private GLabel nextButton;
	
	public FinalRestingScenePane(MainApplication mainScreen) {
	...
	private void addPlaceholderText() {
		GLabel text = new GLabel("Final Resting Scene", 100, 70);
	...
	public void mouseClicked(MouseEvent e) {
		if (mainScreen.getElementAtLocation(e.getX(), e.getY()) == nextButton) {
			mainScreen.switchToScene6Screen();
		}
	}
}
