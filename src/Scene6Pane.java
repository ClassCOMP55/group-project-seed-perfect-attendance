...
public class Scene6Pane extends GraphicsPane{
	private GLabel nextButton;
	
	public Scene6Pane(MainApplication mainScreen) {
	...
	private void addPlaceholderText() {
		GLabel text = new GLabel("Scene 6", 100, 70);
	...
	public void mouseClicked(MouseEvent e) {
		if (mainScreen.getElementAtLocation(e.getX(), e.getY()) == nextButton) {
			mainScreen.switchToEndingScreen();
		}
	}
}
