...
public class Scene4Pane extends GraphicsPane{
	private GLabel nextButton;
	
	public Scene4Pane(MainApplication mainScreen) {
	...
	private void addPlaceholderText() {
		GLabel text = new GLabel("Scene 4", 100, 70);
	...
	public void mouseClicked(MouseEvent e) {
		if (mainScreen.getElementAtLocation(e.getX(), e.getY()) == nextButton) {
			mainScreen.switchToRestingScene2Screen();
		}
	}
}
