...
public class Scene5Pane extends GraphicsPane{
	private GLabel nextButton;
	
	public Scene5Pane(MainApplication mainScreen) {
	...
	private void addPlaceholderText() {
		GLabel text = new GLabel("Scene 5", 100, 70);
	...
	public void mouseClicked(MouseEvent e) {
		if (mainScreen.getElementAtLocation(e.getX(), e.getY()) == nextButton) {
			mainScreen.switchToFinalRestingSceneScreen();
		}
	}
}
